...
import {
  buildResultCopy,
  getScoreEncouragement,
} from "../../utils/levelTest/resultCopy";
import {
  buildSkillInsights,
  getHeadlineScore,
  summarizeAttempt,
      ...
      <Box>
        ...
        >
          ...
          <Alert
            ...
            sx={{ maxWidth: 720, mx: "auto", mb: 3, textAlign: "left" }}
          >
            Bu test okuma ve kısa dinleme anlama becerilerini ölçer; konuşma ve
            yazma becerilerini ölçmez ve resmî sertifika değildir.
          </Alert>
          <Button
            variant="contained"
            size="large"
        ...
        >
          <Typography sx={{ ...levelTestHeadingSx, fontSize: "1.15rem" }}>
            İngilizceni geliştirmeye hazır mısın?
          </Typography>
          <Typography sx={{ color: "#526675", mt: 0.75, mb: 1.5 }}>
            Aden Academy kurslarını incele ve seviyene uygun bir sonraki adımı
            seç.
          </Typography>
          <Button
            component={Link}
      ...
      <Box sx={{ display: "grid", gap: 2 }}>
        ...
        >
          <Box sx={{ textAlign: { xs: "center", md: "left" } }}>
            ...
            {copy.approachingNote ? (
              <Chip
                label={copy.approachingNote}
            ...
            <Box sx={{ mt: 1.5, display: "grid", gap: 1 }}>
              {skills.map((skill) => (
                ...
                >
                  ...
                  <Chip
                    label={`${skill.statusLabel} · ${skill.correct}/${skill.total}`}
                    size="small"
                    sx={{
                      bgcolor:
                        skill.status === "developing" ? "#fff0ea" : "#eaf7ef",
                      color: "#01435A",
                    }}
                  />
                </Box>
        ...
        <Alert severity="info">
          Bu sonuç resmî bir sertifika değildir; okuma ve kısa dinleme
          sorularındaki performansına dayanan bir tahmindir. Konuşma ve yazma
        ...
        <Button
          ...
          sx={{ color: "#0052a3", fontWeight: 700, textTransform: "none" }}
        >
          Testi tekrarla
        </Button>
  ...
  if (!currentStep || !currentPassage) {
    return (
      <Alert severity="error">
        Test içeriği yüklenemedi. Lütfen sayfayı yenileyip tekrar dene.
      </Alert>
    );
  }

  const answered = currentStep.questions.filter((question) =>
