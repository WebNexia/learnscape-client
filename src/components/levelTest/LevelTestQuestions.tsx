      ...
      return (
        <Box
          ...
          sx={{
            ...levelTestCardSx,
            p: { xs: 2, sm: 2.5 },
            boxShadow: "0 8px 24px rgba(1,67,90,.06)",
          }}
        >
          <FormControl component="fieldset" fullWidth>
            ...
            {isGapFillQuestion(question) ? (
              <TextField
                value={selected}
                onChange={(event) =>
                  onChange(question.id, event.target.value.slice(0, 80))
                }
                ...
                {question.options.map((option) => (
                  <FormControlLabel
                    ...
                    sx={{
                      ...
                      borderRadius: 2,
                      bgcolor:
                        selected === option.id ? "rgba(0,82,163,.06)" : "#fff",
                    }}
                  />
                ))}
              </RadioGroup>
