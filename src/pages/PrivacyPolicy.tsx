	...
	const content = {
		tr: {
			...
			dataCategories: [
				...
				},
				{
					...
					items: [
						...
						'Sayfa yolu ve yönlendiren site (birinci taraf trafik ölçümü)',
			...
			legalBasis: [
				...
				},
				{
					...
					items: [
						...
						'Birinci taraf, çerezsiz site trafik ölçümü (hash’lenmiş IP, sayfa yolu, yaklaşık konum)',
						'Pratik derslerde eğitim amaçlı AI geri bildirimi',
					],
				},
				{
					title: '4.4 Açık Rıza',
					items: ['Pazarlama e-posta iletişimleri', 'Opsiyonel çerez kullanımı (kalıcı analitik ziyaretçi kimliği dahil)'],
				},
			],
			...
			cookiePurposes: [
				...
				'İsteğe bağlı çerez onayı verildiğinde kalıcı analitik ziyaretçi kimliği',
				'Gömülü video platformları (YouTube, Vimeo, Dailymotion) tarafından ayarlanan çerezler',
			],
			section11Note:
				'Platformda üçüncü taraf reklam veya pazarlama izleme pikselleri (Meta Pixel, Google Analytics vb.) kullanılmamaktadır. Birinci taraf, çerezsiz trafik ölçümü meşru menfaat kapsamında yapılabilir; kalıcı ziyaretçi kimliği yalnızca isteğe bağlı çerez onayı ile kullanılır. Pazarlama iletişimleri yalnızca açık e-posta onayınız ile yapılır.',
		...
		en: {
			...
			dataCategories: [
				...
				},
				{
					...
					items: [
						...
						'Page path and referring site (first-party traffic measurement)',
			...
			legalBasis: [
				...
				},
				{
					...
					items: [
						...
						'First-party cookieless site traffic measurement (hashed IP, page path, approximate location)',
						'Educational AI feedback in practice lessons',
					],
				},
				{
					title: '4.4 Explicit Consent',
					items: ['Marketing email communications', 'Optional cookie usage (including a persistent analytics visitor ID)'],
				},
			],
			...
			cookiePurposes: [
				...
				'Persistent analytics visitor ID when optional cookies are accepted',
				'Cookies set by embedded video platforms (YouTube, Vimeo, Dailymotion)',
			],
			section11Note:
				'The platform does not use third-party advertising or marketing tracking pixels (Meta Pixel, Google Analytics, etc.). First-party cookieless traffic measurement may be carried out on the basis of legitimate interests; a persistent visitor ID is used only if optional cookies are accepted. Marketing communications are sent only with your explicit email consent.',
