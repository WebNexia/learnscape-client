			...
			<Box
				...
				<Box sx={{ position: 'relative', zIndex: 2 }}>
					<LandingPageLayout>
						...
						<Container maxWidth='md' sx={{ marginTop: { xs: '13vh', md: '15vh' } }}>
							<Grid container spacing={4}>
								<Grid item xs={12} md={6}>
									<Paper
										...
										<Typography variant='h3' sx={{ color: 'white', fontWeight: 700, mb: 1, fontFamily: 'Varela Round', textAlign: 'center', fontSize: { xs: '1.35rem', sm: '1.5rem', md: '1.85rem' } }}>
											Misyonumuz
										</Typography>
