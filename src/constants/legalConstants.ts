...
export const COMPANY_REGISTRATION_EN = `Registered in England & Wales | Company No. ${COMPANY_NUMBER}`;
export const COMPANY_REGISTRATION_TR = `İngiltere ve Galler'de kayıtlı | Şirket No: ${COMPANY_NUMBER}`;
