...
const levelGuides: Record<CefrLevel, ReadingLevelGuide> = {
  A1: {
    ...
    suitableTexts: [
      "Kısa A1 hikayeleri ve basit diyaloglar",
      "Tabelalar, kısa mesajlar ve günlük notlar",
      "Tekrarlı cümleler ve net bir sonu olan metinler",
    ],
  },
  A2: {
    meaningParagraphs: [
    ...
    suitableTexts: [
      "Kısa A2 hikayeleri ve günlük yaşam metinleri",
      "Basit e-postalar, tarifler ve seyahat notları",
      "Neden-sonuç bağları açık olan sade anlatılar",
    ],
  },
  B1: {
    meaningParagraphs: [
    ...
    suitableTexts: [
      "B1 seviyesinde yazılmış hikayeler ve kişisel anlatılar",
      "Blog yazıları, haber özetleri ve günlük yaşam metinleri",
      "Ana fikir ile detayın net ayrıldığı bağlantılı metinler",
    ],
  },
  B2: {
    meaningParagraphs: [
    ...
    suitableTexts: [
      "B2 hikayeleri, görüş yazıları ve tartışmacı metinler",
      "Fikirlerin dolaylı verildiği makaleler ve röportajlar",
      "Tutum, karşıtlık ve satır arası anlam içeren anlatılar",
    ],
  },
  C1: {
    meaningParagraphs: [
    ...
    suitableTexts: [
      "C1 seviyesinde uzun hikayeler ve denemeler",
      "Soyut, tartışmacı veya analitik makaleler",
      "Üslup ve örtük anlamın öne çıktığı edebi anlatılar",
    ],
  },
  C2: {
    meaningParagraphs: [
    ...
    suitableTexts: [
      "C2 hikayeleri, edebi anlatılar ve karmaşık denemeler",
      "İma, ton ve retorik ayrıntısı yüksek metinler",
      "Birden fazla bakış açısını aynı anda taşıyan uzun yazılar",
    ],
  },
};
...
const belowA1Guide: ReadingLevelGuide = {
  ...
  suitableTexts: [
    "Çok kısa A1 hikayeleri",
    "Basit diyaloglar ve tekrarlı cümleler",
    "Tek bir olay üzerine kurulu net metinler",
  ],
};
...
export function getReadingLevelGuide(outcome: AssessmentOutcome) {
  return outcome.resultType === "below_a1" || !outcome.finalLevel
    ? belowA1Guide
    : levelGuides[outcome.finalLevel];
}
...
export function buildResultCopy(outcome: AssessmentOutcome): ReadingResultCopy {
  if (outcome.resultType === "below_a1" || !outcome.finalLevel) {
    return {
      ...
      description:
        "Kısa ve basit cümlelerle yazılmış hikayelerle başlamak, okuduğunu anlama becerini en hızlı geliştiren yol.",
      meaningParagraphs: [
      ...
      nextGoalLead:
        "Kısa A1 hikayeleriyle günlük kelimeleri ve basit cümleleri daha rahat takip edebilirsin.",
  ...
  return {
    ...
    approachingNote: outcome.approachingLevel
      ? `${outcome.approachingLevel} seviyesine yaklaşıyorsun.`
      : null,
    nextGoalLevel: nextLevel,
    nextGoalTitle: nextLevel
      ? `Bir sonraki hedefin: ${nextLevel}`
      : "Seviyeni koru",
