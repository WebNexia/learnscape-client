...
const a1Listening = listening(
  ...
  [
    choice(
      ...
      ["In the park.", "In her office.", "At the bus stop.", "In a shop."],
      "A",
    ),
    choice(
      "a1-l2",
...
const a2Reading = reading(
  ...
  [
    choice(
      ...
      [
        "Why supermarkets are always cheaper.",
        "How Sara's Saturday shopping changed.",
        "A new café next to Sara's flat.",
        "Sara's job at the market.",
      ],
      "B",
    ),
    gap(
      "a2-r2",
      "Sara still buys pasta and cleaning products at the ______.",
      "supermarket",
...
const a2Listening = listening(
  ...
  [
    ...
    choice(
      "a2-l2",
      "inference",
      "How did Mark's family react when he arrived?",
      [
        "They were still waiting outside.",
        "They had already left.",
        "They were not angry with him.",
        "They asked him to cook dinner.",
      ],
      "C",
    ),
  ],
...
const a2ListeningTwo = listening(
  ...
  [
    choice(
      ...
      ["At nine.", "At ten.", "At forty minutes past nine.", "After dinner."],
      "B",
    ),
    choice(
      "a2-l4",
      ...
      [
        "They will cancel the day.",
        "They will wait at the station.",
...
const a2Verification = reading(
  ...
  [
    ...
    choice(
      ...
      [
        "She thinks it is the best part of her week.",
        "She wants to stop going to the market.",
        "She prefers to stay at home.",
        "She is bored of shopping.",
      ],
      "A",
    ),
  ],
  ...
  [
    choice(
      ...
      [
        ...
        "How Lena learned to protect her evenings at home.",
        "A new dinner restaurant near Lena's house.",
        "Why emails are faster than meetings.",
      ],
      "B",
    ),
    gap("b1-r2", "Lena now closes her laptop at ______.", "seven", [
      "seven",
      "7",
      "7 o'clock",
      "seven o'clock",
    ...
    choice(
      "b1-r3",
      "explicit_detail",
      "Why did Lena make a rule about her laptop?",
      [
        "Her company asked her to work later.",
        "She found it hard to stop working at home.",
        "She wanted more evening emails.",
        "The office closed at seven.",
      ],
      "B",
    ),
  ],
...
const b1Listening = listening(
  ...
  [
    choice(
      ...
      [
        "It closed in the mornings.",
        "It removed the café.",
        "It added a booking system for study rooms.",
        "It stopped students from staying late.",
      ],
      "C",
    ),
    choice(
    ...
    choice(
      ...
      [
        ...
        "It helps them finish their work.",
        "It is empty all day.",
        "It no longer allows talking anywhere.",
      ],
      "B",
    ),
  ],
...
const b1Verification = reading(
  ...
  [
    ...
    choice(
      "b1-v2",
      "inference",
      "How did the colleague react in the end?",
      [
        "He asked Lena to stop the rule.",
        "He also tried the same rule.",
        "He moved to another company.",
        "He worked later than before.",
      ],
      "B",
    ),
    choice(
...
const b2Reading = reading(
  ...
  [
    choice(
      ...
      [
        "Remote meetings often expand because they are too easy to fill.",
        "Offices should close permanently.",
        "Travel always improves discussion.",
        "Managers should ban all meetings.",
      ],
      "A",
    ),
    gap(
      "b2-r2",
      "According to the text, the work often starts only after the meetings ______.",
      "end",
      ["end", "finish", "are over"],
    ),
    choice(
      "b2-r3",
      "inference",
      "What does the writer suggest about cheap, easy meetings?",
      [
        "They are always more useful than emails.",
        "They can replace the need for any written update.",
        "Their convenience can hide the time they waste.",
        "Managers call them only after a long train journey.",
      ],
      "C",
    ),
  ],
...
const b2Listening = listening(
  ...
  [
    ...
    choice(
      "b2-l2",
      "inference",
      "What unexpected benefit does the speaker mention?",
      [
        "The grant paid for new apartments.",
        "Neighbours started to know one another.",
        "The roofs produced enough food for the city.",
        "People stopped using the streets.",
      ],
      "B",
    ),
    choice(
...
const b2Verification = reading(
  ...
  [
    choice(
      ...
      [
        "To cancel all written notes.",
        "To decide which conversations really need a meeting.",
        "To make staff travel more.",
        "To measure the speed of trains.",
      ],
      "B",
    ),
    choice(
      ...
      [
        "They usually aim at a decision.",
        "They last the whole afternoon.",
        "They have no agenda.",
        "They replaced all emails.",
      ],
      "A",
    ),
    choice(
      ...
      [
        "They had more time and still learned the important choices.",
        "They asked to travel across town every day.",
        "They stopped reading the written summaries.",
        "They wanted longer meetings than before.",
      ],
      "A",
    ),
  ],
...
const c1Reading = reading(
  ...
  [
    choice(
      ...
      [
        "People should simply try harder to focus.",
        "Poor concentration is mainly a design problem, not a private weakness.",
        "All digital tools should be banned.",
        "Willpower is the only reliable solution.",
      ],
      "B",
    ),
    gap(
      "c1-r2",
      "According to the writer, many platforms treat interruption as a ______.",
      "feature",
      ["feature"],
    ),
    choice(
      ...
      [
        "The people who answer every notification at once.",
        "The people who have made it harder for machines to interrupt them.",
        "Only those with unusually strong willpower.",
        "Anyone who uses more platforms than before.",
      ],
      "B",
    ),
  ],
...
const c1Listening = listening(
  ...
  [
    choice(
      ...
      [
        "It has no labels and very few objects.",
        "It is closed to visitors.",
        "It contains the museum's oldest paintings.",
        "It is used only for school groups.",
      ],
      "A",
    ),
    choice(
      "c1-l2",
      "attitude",
      "How do visitors respond to the room?",
      [
        "Everyone immediately likes it.",
        "Reactions are mixed: some feel restless, others feel able to think.",
        "They ask for more labels on every wall.",
    ...
    choice(
      "c1-l3",
      "explicit_detail",
      "What has the museum decided to do?",
      [
        "Close the room if any visitor complains.",
        "Fill the room with labels next week.",
        "Keep the room for a year even if opinions stay divided.",
        "Move the bench into the busiest gallery.",
      ],
      "C",
    ),
  ],
...
const c1Verification = reading(
  ...
  [
    choice(
      ...
      [
        "They are usually built to serve their own measurements.",
        "They always help people finish work faster.",
        "They are more honest than quiet tools.",
        "They should be used all evening.",
      ],
      "A",
    ),
    choice(
    ...
    choice(
      ...
      [
        "Because it produces fewer alerts to count.",
        "Because nobody ever finishes work with it.",
        "Because users never asked for alerts.",
        "Because it waits more than five hours.",
      ],
      "A",
    ),
  ],
...
const c2Reading = reading(
  ...
  [
    choice(
      ...
      [
        "Competent people may keep solving the wrong problems with great skill.",
        "Only inexperienced people feel restless at work.",
        "Mastery always produces happiness.",
        "Standards should never be questioned.",
      ],
      "A",
    ),
    gap(
      "c2-r2",
      "The writer says this restlessness is a kind of motion without ______.",
      "destination",
    ...
    choice(
      "c2-r3",
      "inference",
      "Which question does the writer think the competent person should ask?",
      [
        "How can I fill the calendar even more?",
        "Why is this the problem I am so busy solving?",
        "How can I earn praise more quickly?",
        "Which inherited problem should I solve first tomorrow?",
      ],
      "B",
    ),
  ],
...
const c2Listening = listening(
  ...
  [
    choice(
      ...
      [
        "Only the most important official reports.",
        "The ones somebody could not quite throw away.",
        "Every newspaper from the period.",
        "Only letters that were never opened.",
      ],
      "B",
    ),
    choice(
      ...
      [
        "They are easier to read than newspapers.",
        "They show what people nearly said, not only what they claimed.",
        "They prove that archives are complete.",
        "They replace the need for public records.",
      ],
      "B",
    ),
    choice(
      "c2-l3",
      "inference",
      "What does the speaker suggest we may need in order to understand a decision?",
      [
        "Only the headlines from that week.",
        "A complete list of every official report.",
        "The version of the thought that never reached the public.",
        "A letter that was never written at all.",
      ],
      "C",
    ),
  ],
...
const c2Verification = reading(
  ...
  [
    choice(
      ...
      [
        "Avoiding work because one is unskilled.",
        "Refusing tasks that are not worth the ability they would use.",
        "Asking other people to become more competent.",
        "Working longer hours on every request.",
      ],
      "B",
    ),
    choice(
      ...
      [
        "As usually mistaken.",
        "As the best judges of talent.",
        "As more honest than the writer.",
        "As people who should rest more.",
      ],
      "A",
    ),
    choice(
      "c2-v3",
      "inference",
      "Why does the writer want some talent to remain unused?",
      [
        "So it stays available for a problem that is actually worth the cost.",
        "So competent people can look lazy on purpose.",
        "So every request can be answered on the same day.",
        "So inherited problems never get solved.",
      ],
      "A",
    ),
  ],
