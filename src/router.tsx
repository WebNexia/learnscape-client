...
const LandingPageCourses = React.lazy(
  () => import("./pages/LandingPageCourses"),
);
const LandingPageConsultations = React.lazy(
...
const SubmissionFeedbackDetails = React.lazy(
  () => import("./pages/SubmissionFeedbackDetails"),
);
const Calendar = React.lazy(() => import("./pages/Calendar"));
const Messages = React.lazy(() => import("./pages/Messages"));
const Community = React.lazy(() => import("./pages/Community"));
const CommunityTopicPage = React.lazy(
  () => import("./pages/CommunityTopicPage"),
);
const Settings = React.lazy(() => import("./pages/Settings"));
const AdminSetup = React.lazy(() => import("./pages/AdminSetup"));
const ZoomMeetingPage = React.lazy(() => import("./pages/ZoomMeetingPage"));
const EventRecordingPage = React.lazy(
  () => import("./pages/EventRecordingPage"),
);
const CoursePage = React.lazy(() => import("./pages/CoursePage"));
const LessonPage = React.lazy(() => import("./pages/LessonPage"));
const AdminCourseEditPage = React.lazy(
  () => import("./pages/AdminCourseEditPage"),
);
const AdminCourseAnalytics = React.lazy(
  () => import("./pages/AdminCourseAnalytics"),
);
const AdminCourses = React.lazy(() => import("./pages/AdminCourses"));
const StaffCoursePreviewPage = React.lazy(
  () => import("./pages/StaffCoursePreviewPage"),
);
const StaffLessonPreviewPage = React.lazy(
  () => import("./pages/StaffLessonPreviewPage"),
);
const CourseRoster = React.lazy(() => import("./pages/CourseRoster"));
const AdminLessons = React.lazy(() => import("./pages/AdminLessons"));
const AdminLessonEditPage = React.lazy(
  () => import("./pages/AdminLessonEditPage"),
);
...
const AdminConsultationSlots = React.lazy(
  () => import("./pages/AdminConsultationSlots"),
);
const AdminConsultationAppointments = React.lazy(
  () => import("./pages/AdminConsultationAppointments"),
);
const Resources = React.lazy(() => import("./pages/Resources"));
const ResourceItems = React.lazy(() => import("./pages/ResourceItems"));
const AdminCheckoutsFeedback = React.lazy(
  () => import("./pages/AdminCheckoutsFeedback"),
);
const AdminQuizSubmissions = React.lazy(
  () => import("./pages/AdminQuizSubmissions"),
);
const AdminQuizSubmissionCheck = React.lazy(
...
const AdminCourseFeedbackForms = React.lazy(
  () => import("./pages/AdminCourseFeedbackForms"),
);
const AdminForms = React.lazy(() => import("./pages/AdminForms"));
const AdminFeedbackFormTemplates = React.lazy(
  () => import("./pages/AdminFeedbackFormTemplates"),
);
const FeedbackFormSubmissions = React.lazy(
  () => import("./pages/FeedbackFormSubmissions"),
);
const PublicFeedbackFormPage = React.lazy(
  () => import("./pages/PublicFeedbackFormPage"),
);
...
const ConfirmEmailChangePage = React.lazy(
  () => import("./pages/ConfirmEmailChangePage"),
);
const RecoverEmailPage = React.lazy(() => import("./pages/RecoverEmailPage"));
const HandleAuthResetPassword = React.lazy(
  () => import("./pages/HandleAuthResetPassword"),
);
...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "landing-page-clubs/:name/:clubId/payment/qa-test",
        element: <LandingPageClubPayment />,
      },
      {
        path: "landing-page-clubs/:name/:clubId/payment",
        element: <LandingPageClubPayment />,
      },
      {
      ...
      {
        path: "courses/certificates/verify/:certificateId",
        element: <CertificateVerificationPage />,
      },
      { path: "zoom-meeting/:eventId", element: <ZoomMeetingPage /> },
      {
        path: "event-recording/:eventId/:recordingId?",
        element: <EventRecordingPage />,
      }, // recordingId optional for YouTube recordings
